<template>
	<aside :class="`${is_expanded ? 'is-expanded' : ''}`">
		...
		<h3>Menu</h3>
		<div class="menu">
			<router-link to="/admin" v-if="isAdmin" class="button">
				<span class="material-icons">analytics</span>
				<span class="text">Admin Home</span>
			</router-link>
			<router-link to="/accounts" v-if="isAdmin" class="button">
				<span class="material-icons">manage_accounts</span>
				<span class="text">Manage Accounts</span>
			</router-link>
			<router-link to="/announce" v-if="isAdmin" class="button">
			...
			<router-link to="/machines" class="button">
